...
import { Users, DollarSign, BookOpen, BarChart2, AlertTriangle, CheckCircle, Bell } from "lucide-react"
    ...
    <div className="flex flex-col gap-6 p-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">
          Manage your platform, users, and content from a central location
        </p>
      </div>
                ...
                {alertItems.map((alert) => (
                  <div key={alert.id} className="flex items-start gap-4 rounded-lg border p-3">
                    <div className={cn(
                      ...
                      alert.severity === 'warning' ? "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-300" :
                      alert.severity === 'success' ? "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300" :
